...
%
% WENDLANDC0 - Implements Wendland's C0 Compactly Supported Radial Basis Function (RBF)
%
% Description:
%   This class defines Wendland's C0 RBF, a compactly supported and positive 
%   definite function that is commonly used for interpolation and approximation 
%   tasks. Wendland's C0 RBF is defined as:
%       φ(r) = (1 - r/a)^2, for r ≤ a, and 0 otherwise.
%   The compact support ensures sparse system matrices, which improves 
%   computational efficiency.
%
% Syntax:
%   obj = WendlandC0();        % Create an instance of the WendlandC0 RBF class
%   v = obj.rbf(r, a);         % Evaluate the Wendland C0 RBF
%
% Inputs:
...
%
% Example:
%   % Create an instance of WendlandC0 RBF class
%   phi = WendlandC0();
%
...
%   xlabel('Distance (r)');
%   ylabel('RBF Value');
%   title('Wendland C0 Radial Basis Function');
%
% Methods:
%   rbf(r, a)       - Computes the Wendland C0 RBF values for a given distance matrix `r` 
%                     and shape parameter `a`.
%   D1(r, a, x)     - Placeholder for the first derivative of the Wendland C0 RBF 
%                     (returns an empty array).
%   D2(r, a, x)     - Placeholder for the second derivative of the Wendland C0 RBF 
%                     (returns an empty array).
%   D3(r, a, x)     - Placeholder for the third derivative of the Wendland C0 RBF 
%                     (returns an empty array).
%   D4(r, a, x)     - Placeholder for the fourth derivative of the Wendland C0 RBF 
%                     (returns an empty array).
...
%
% Notes:
%   - Wendland's C0 RBF is compactly supported, which ensures sparse matrices 
%     for numerical computations.
%   - The RBF value is set to 0 for distances greater than `a` (r > a).
